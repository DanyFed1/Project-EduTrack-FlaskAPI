...
def test_get_student_by_id(mock_find_student_by_id, client):
    mock_find_student_by_id.return_value = MockModel(
...
def test_add_new_student(mock_add_new_student, client):
    mock_add_new_student.return_value = {
        'message': 'Student added successfully', 'student_id': 1}
...
def test_get_students_by_course_id(mock_find_students_by_course_id, client):
    mock_find_students_by_course_id.return_value = [
        MockModel(id=1, first_name='John', last_name='Doe')]
...
def test_get_course_by_id(mock_find_course_by_id, client):
    mock_find_course_by_id.return_value = MockModel(
